...
def parse_args():
    ...
    parser.add_argument('--model-dir', type=str, default=os.environ.get('SM_MODEL_DIR', '/opt/ml/model'), help='Contents of this directory get uploaded to the output prefix mentioned in your launch script.')
    parser.add_argument('--train-dir', type=str, default=os.environ.get('SM_CHANNEL_TRAINING', '/opt/ml/input/data/training'), help='This is where the s3 data is downloaded.')
    parser.add_argument('--checkpoint-dir', type=str, default=os.environ.get('SM_CHECKPOINT_DIR', '/opt/ml/checkpoints'), help='Synchronization with the checkpoint config, gets updated after every epoch.')
...
def main():
    ...
    for epoch in range(epochs):
        ...
        if True:
            ...
            print(f'Checkpoint for epoch - {epoch}, periodically saved')
